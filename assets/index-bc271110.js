...
`,a.appendChild(n),document.body.appendChild(a)},y=()=>{var a=document.createElement("div");a.id="myDivNav",document.body.appendChild(a);var o=document.createElement("div");o.className="mydivClass",o.id="btnInicio",o.innerHTML="Mensulas",a.appendChild(o),document.getElementById("btnInicio").addEventListener("click",()=>{f()});var n=document.createElement("div");n.className="mydivClass",n.id="btnQsomos",n.innerHTML="Escritorios",a.appendChild(n),document.getElementById("btnQsomos").addEventListener("click",()=>{s()});var m=document.createElement("div");m.className="mydivClass",m.id="btnDescargas",m.innerHTML="Mesa ratona",a.appendChild(m),document.getElementById("btnDescargas").addEventListener("click",()=>{l()});var u=document.createElement("div");u.className="mydivClass",u.id="btnContacto",u.innerHTML="Varios",a.appendChild(u),document.getElementById("btnContacto").addEventListener("click",()=>{b()})},C=()=>{let a=document.createElement("div");a.id="myDivNav2",a.innerHTML=`
  ...
  `;const a=document.getElementById("items"),o=document.getElementById("template-card").content,n=document.createDocumentFragment(),m=async()=>{try{const t=await(await fetch("catalogo/mensula.json")).json();u(t)}catch(e){console.log(e)}},u=e=>{e.forEach(t=>{o.querySelector("h5").textContent=t.title,o.querySelector("p").textContent=t.precio,o.querySelector("img").setAttribute("src",t.thumbnailUrl),o.querySelector(".btn-dark").dataset.id=t.id;const d=o.cloneNode(!0);n.appendChild(d)}),a.appendChild(n)};m();async function h(){const e=document.querySelector("#contacto"),t=document.querySelector("#idCatalogo");if(!e.value){t.textContent="";return}try{const r=await(await fetch("catalogo/mensula.json")).json(),g=e.value.toLowerCase(),p=r.filter(i=>i.title.toLowerCase()===g);p.length>0?(t.innerHTML="",p.forEach(i=>{t.innerHTML+=`
        ...
        `})):t.textContent="No se encontraron resultados."}catch(c){console.error("Error al cargar el archivo JSON:",c)}}async function v(){const e=document.getElementById("contacto");try{(await(await fetch("catalogo/mensula.json")).json()).forEach(c=>{const r=document.createElement("option");r.value=c.title,r.textContent=c.title,e.appendChild(r)}),e.addEventListener("change",h)}catch(t){console.error("Error al cargar el archivo JSON:",t)}}v()},s=()=>{document.querySelector("#myDivNav2").innerHTML=`
    <div class = "marcoDivNav2">
                            <select id="contacto">
                            <option value="">Seleccionar Artículo</option>
                            </select>
  ...
  `;const a=document.getElementById("items"),o=document.getElementById("template-card").content,n=document.createDocumentFragment(),m=async()=>{try{const t=await(await fetch("catalogo/escritorio.json")).json();u(t)}catch(e){console.log(e)}},u=e=>{e.forEach(t=>{o.querySelector("h5").textContent=t.title,o.querySelector("p").textContent=t.precio,o.querySelector("img").setAttribute("src",t.thumbnailUrl),o.querySelector(".btn-dark").dataset.id=t.id;const d=o.cloneNode(!0);n.appendChild(d)}),a.appendChild(n)};m();async function h(){const e=document.querySelector("#contacto"),t=document.querySelector("#idCatalogo");if(!e.value){t.textContent="";return}try{const r=await(await fetch("catalogo/escritorio.json")).json(),g=e.value.toLowerCase(),p=r.filter(i=>i.title.toLowerCase()===g);p.length>0?(t.innerHTML="",p.forEach(i=>{t.innerHTML+=`
         <div style="display: grid; place-content: center;">
         <hr>
          <h5> Título: ${i.title}</h5>
          <p><h5> Precio: ${i.precio}</h5></p>
        ...
        `})):t.textContent="No se encontraron resultados."}catch(c){console.error("Error al cargar el archivo JSON:",c)}}async function v(){const e=document.getElementById("contacto");try{(await(await fetch("catalogo/escritorio.json")).json()).forEach(c=>{const r=document.createElement("option");r.value=c.title,r.textContent=c.title,e.appendChild(r)}),e.addEventListener("change",h)}catch(t){console.error("Error al cargar el archivo JSON:",t)}}v()},l=()=>{document.querySelector("#myDivNav2").innerHTML=`
    <div class = "marcoDivNav2">
                            <select id="contacto">
                            <option value="">Seleccionar Artículo</option>
                            </select>
  ...
  `;const a=document.getElementById("items"),o=document.getElementById("template-card").content,n=document.createDocumentFragment(),m=async()=>{try{const t=await(await fetch("catalogo/ratona.json")).json();u(t)}catch(e){console.log(e)}},u=e=>{e.forEach(t=>{o.querySelector("h5").textContent=t.title,o.querySelector("p").textContent=t.precio,o.querySelector("img").setAttribute("src",t.thumbnailUrl),o.querySelector(".btn-dark").dataset.id=t.id;const d=o.cloneNode(!0);n.appendChild(d)}),a.appendChild(n)};m();async function h(){const e=document.querySelector("#contacto"),t=document.querySelector("#idCatalogo");if(!e.value){t.textContent="";return}try{const r=await(await fetch("catalogo/ratona.json")).json(),g=e.value.toLowerCase(),p=r.filter(i=>i.title.toLowerCase()===g);p.length>0?(t.innerHTML="",p.forEach(i=>{t.innerHTML+=`
         <div style="display: grid; place-content: center;">
         <hr>
          <h5> Título: ${i.title}</h5>
          <p><h5> Precio: ${i.precio}</h5></p>
        ...
        `})):t.textContent="No se encontraron resultados."}catch(c){console.error("Error al cargar el archivo JSON:",c)}}async function v(){const e=document.getElementById("contacto");try{(await(await fetch("catalogo/ratona.json")).json()).forEach(c=>{const r=document.createElement("option");r.value=c.title,r.textContent=c.title,e.appendChild(r)}),e.addEventListener("change",h)}catch(t){console.error("Error al cargar el archivo JSON:",t)}}v()},b=()=>{document.querySelector("#myDivNav2").innerHTML=`
    <div class = "marcoDivNav2">
                            <select id="contacto">
                            <option value="">Seleccionar Artículo</option>
                            </select>
  ...
  `;const a=document.getElementById("items"),o=document.getElementById("template-card").content,n=document.createDocumentFragment(),m=async()=>{try{const t=await(await fetch("catalogo/varios.json")).json();u(t)}catch(e){console.log(e)}},u=e=>{e.forEach(t=>{o.querySelector("h5").textContent=t.title,o.querySelector("p").textContent=t.precio,o.querySelector("img").setAttribute("src",t.thumbnailUrl),o.querySelector(".btn-dark").dataset.id=t.id;const d=o.cloneNode(!0);n.appendChild(d)}),a.appendChild(n)};m();async function h(){const e=document.querySelector("#contacto"),t=document.querySelector("#idCatalogo");if(!e.value){t.textContent="";return}try{const r=await(await fetch("catalogo/varios.json")).json(),g=e.value.toLowerCase(),p=r.filter(i=>i.title.toLowerCase()===g);p.length>0?(t.innerHTML="",p.forEach(i=>{t.innerHTML+=`
         <div style="display: grid; place-content: center;">
         <hr>
          <h5> Título: ${i.title}</h5>
          <p><h5> Precio: ${i.precio}</h5></p>
        ...
        `})):t.textContent="No se encontraron resultados."}catch(c){console.error("Error al cargar el archivo JSON:",c)}}async function v(){const e=document.getElementById("contacto");try{(await(await fetch("catalogo/varios.json")).json()).forEach(c=>{const r=document.createElement("option");r.value=c.title,r.textContent=c.title,e.appendChild(r)}),e.addEventListener("change",h)}catch(t){console.error("Error al cargar el archivo JSON:",t)}}v()},w=()=>{let a=document.createElement("div"),o=document.createElement("div");o.id="divDatos1",o.innerHTML=`
    <hr>
